...
#  numa conta de poupança (10% do total arrecadado). Você foi contratado para fazer os cálculos para o dono. Com base nestes fatos, 
# faça um algoritmo para que de acordo com as quantidades de pães e de broas, calcule os dados solicitados. 